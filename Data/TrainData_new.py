...
class TrainData(Dataset):
    def __init__(self, block_size, debug=False):
        ...
        images_sum = list()
        dir_images = ['/backup2/whduan/Openimage/train_00_yuv/*.yuv','/backup2/whduan/Openimage/train_01_yuv/*.yuv',\
            '/backup2/whduan/Openimage/train_02_yuv/*.yuv','/backup2/whduan/Openimage/train_03_yuv/*.yuv',\
                '/backup2/whduan/Openimage/train_05_yuv/*.yuv', '/backup2/whduan/Openimage/train_06_yuv/*.yuv',\
                     '/backup2/whduan/Openimage/train_07_yuv/*.yuv','/backup2/whduan/Openimage/train_08_yuv/*.yuv']
        print(dir_images)   
        for i in dir_images:
...
#         # files = [item for item in root.iterdir()]   
#         images_sum = list()
#         dir_images = ["/media/lingbo/duanwenhong/dataset/*.yuv"]
#         print(dir_images)
